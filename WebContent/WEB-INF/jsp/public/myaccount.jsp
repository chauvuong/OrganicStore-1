			...
			<div class="row">
				<div class="col-md-3 col-lg-2 p-b-30">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item p-b-16"><a class="nav-link"
							data-toggle="tab" href="#dashboard" role="tab">Thống Kê</a></li>

						<li class="nav-item p-b-16"><a class="nav-link"
							data-toggle="tab" href="#orders" role="tab">Đơn Đặt Hàng</a></li>

						<li class="nav-item p-b-16"><a class="nav-link"
							data-toggle="tab" href="#addresses" role="tab">Địa Chỉ</a></li>
				...
				<div class="col-md-9 col-lg-10 p-b-30">
					...
					<div class="tab-content p-l-70 p-l-0-lg">
						<!--!Detail- -->
						<div class="tab-pane fade show active" id="accountdetail"
							role="tabpanel">

							<form
								action="${pageContext.request.contextPath }/myaccount/edit/${userInfo.id_member } "
								method="POST" role="form">
								<legend>Thông Tin</legend>
								<div class="form-group">
									<label for="">Họ Và Tên</label> <input id="n" disabled
										type="text" class="form-control"
										<c:if test="${userInfo != null}"> value="${userInfo.fullname}"</c:if>>
								</div>
								<div class="form-group">
									<label for="">Số Điện Thoại</label> <input id="p" disabled
										type="text" class="form-control"
										<c:if test="${userInfo != null}"> value="${userInfo.phone}"</c:if>>
								</div>
								<div class="form-group">
									<label for="">Địa Chỉ</label> <input id="a" disabled
										type="text" class="form-control"
										<c:if test="${userInfo != null}"> value="${userInfo.address}"</c:if>>
								</div>
								<div class="form-group">
									<label for="">Email</label> <input id="e" disabled type="text"
										class="form-control"
								...
								<button id="bs" onclick="dedit()" style="display: none"
					 ...
					 <div class="tab-pane fade" id="orders" role="tabpanel">
								...
								<section class="panel">
									<table class="table table-striped table-advance table-hover">
										<tbody>
											...
											<c:forEach items="${objOderDetail}" var="objDetail">
						...
						<div class="tab-pane fade" id="addresses" role="tabpanel">
							<p class="txt-s-101 cl6">Các địa chỉ bên dưới sẽ được dùng để
								thanh toán mặc định</p>

							<div class="flex-w flex-sb p-t-37">
								<div class="size-w-63 flex-t w-full-sm p-b-35">
									<div class="size-w-53 p-r-30">
										<h5 class="txt-m-109 cl3 p-b-7">Địa chỉ thanh toán</h5>

										<p class="txt-s-101 cl6">Chưa được thiết lập</p>
									</div>
								...
								<div class="size-w-63 flex-t w-full-sm p-b-35">
									<div class="size-w-53 p-r-30">
										<h5 class="txt-m-109 cl3 p-b-7">Địa chỉ giao hàng</h5>

				...
				<div class="leftbar p-t-15">
					...
					<div class="size-a-21 pos-relative">
						<input class="s-full bo-all-1 bocl15 p-rl-20" type="text"
							name="search" placeholder="Search sảm phẩm...">
					...
					<!--  -->
					<div class="p-t-45">
						<h4 class="txt-m-101 cl3">LỌC THEO GIÁ</h4>
						...
						<div class="filter-price p-t-32">
							...
							<div class="flex-sb-m flex-w p-t-16">
								...
								<div>
									<a href="#" class="txt-s-107 cl6 hov-cl10 trans-04"> Lọc </a>
								</div>
							</div>
						</div>
					</div>
							...
							<c:forEach var="objCat" items="${listCat }">
								...
								<li class="p-b-5"><a href="${slugName }"
									class="flex-sb-m flex-w txt-s-101 cl6 hov-cl10 trans-04 p-tb-3">
										<span class="m-r-10">${objCat.name} </span> <span> ${productDao.countNewPublicCat(objCat.id_cat)} </span>
								</a></li>
							</c:forEach>
					...
					<!-- <hr />
					 -->
					<!-- <div>
						<h4 class="txt-m-101 cl3 p-b-20">THƯƠNG HIỆU</h4>

						<ul>
							<li class="p-b-5"><label> <input class="brand"
									type="checkbox" value=""> Đà Lạt
							</label></li>

							<li class="p-b-5"><label> <input class="brand"
									type="checkbox" value=""> Huế mộng mơ
							</label></li>

							<li class="p-b-5"><label> <input class="brand"
									type="checkbox" value=""> Sóc Trăng
							</label></li>

							<li class="p-b-5"><label> <input class="brand"
									type="checkbox" value=""> Đà Nẵng
							</label></li>
						</ul>
					</div> -->
					<hr />
					...
					<div>
						...
						<div class="rating-wrap-post" style="cursor: pointer">
							<i id="1" class="fa fa-star" onclick="set('1')"></i> <i id="2"
								class="fa fa-star" onclick="set('2')"></i> <i id="3"
								class="fa fa-star" onclick="set('3')"></i> <i id="4"
								class="fa fa-star" onclick="set('4')"></i> <i id="5"
								class="fa fa-star" onclick="set('5')"></i> Trở lên <input
								style="display: none" type="number" style="width:50px;" value=""
								id="star">
					...
					<div class="flex-w flex-r-m p-b-45 flex-row-rev">
						<div class="flex-w flex-m p-tb-8">
							...
							<div class="flex-w flex-m m-tb-7">
								<button
									class="dis-block lh-00 pos-relative how-icon1 m-r-15 js-show-list">
									<img class="icon-main trans-04"
										src="${pageContext.request.contextPath }/templates/public/images/icons/icon-menu-list.png"
										alt="ICON"> <img class="ab-t-l icon-hov trans-04"
										src="${pageContext.request.contextPath }/templates/public/images/icons/icon-menu-list1.png"
										alt="ICON">
								</button>
						...
						<span class="txt-s-101 cl9 m-r-30 size-w-53"> Show 1–12
							trong 23 sản phẩm </span>
					</div>
						...
						<c:forEach var="objProduct" items="${listProduct}">
							...
							<div class="row p-b-30">
								<div class=" col-sm-5 col-lg-4">
									<a href="${urlDetail }"
										class="wrap-pic-w bo-all-1 bocl12 hov8 trans-04"> <img
										src="${pageContext.request.contextPath }/files/${objProduct.picture}"
										alt="PRODUCT">
									</a>
								</div>
									...
									<div class="p-t-5 p-b-20">
										<div class="flex-w flex-sb-m">
											<a href="${urlDetail }"
												...
												${objProduct.name } </a> <a href="wishlist.html"
												class="lh-00 pos-relative how-icon1 m-tb-15 js-addwish1">
												<img class="icon-main trans-04"
												src="${pageContext.request.contextPath }/templates/public/images/icons/icon-heart-color.png"
												alt="ICON"> <img class="ab-t-l icon-hov trans-04"
												src="${pageContext.request.contextPath }/templates/public/images/icons/icon-heart-color2.png"
												alt="ICON">
											</a>
										</div>

										<span class="txt-m-117 cl9"> ${objProduct.price } </span>

										<p class="txt-s-101 cl6 p-t-18">${objProduct.preview }</p>

										<div class="flex-w p-t-29">
											<button onclick="sanpham(${objProduct.id_product})"

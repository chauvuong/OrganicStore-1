			...
			<div id="rev_slider_1" class="rev_slide fullwidthabanner" data-version="5.4.5" style="display:none">
				<ul>
					...
					<li data-transition="fade">
						<!--  -->
						<img src="${pageContext.request.contextPath }/templates/public/images/Banner1.jpg" alt="IMG-BG" class="rev-slidebg">
					...
					<li data-transition="fade">
						<!--  -->
						<img src="${pageContext.request.contextPath }/templates/public/images/Banner6.jpg" alt="IMG-BG" class="rev-slidebg">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-75 isotope-item slide-inner ${objProduct.id_cat }">
					...
					<div class="block1">
						<div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
							<a href="${urlDetail }"><img style="width:268px ; height: 353.22px;" src="${pageContext.request.contextPath }/files/${objProduct.picture}" alt="IMG"></a>

							<div class="block1-content flex-col-c-m p-b-46">
								<a href="${urlDetail }" class="txt-m-103 cl3 txt-center hov-cl10 trans-04 js-name-b1">
									${objProduct.name }
								</a>
...
<%-- 	<section class="sec-deal bg-img1" style="background-image: url('${pageContext.request.contextPath }/templates/public/images/bg-01.jpg');">
		<div class="flex-w flex-m how-pos2-parent">
			...
			<div class="size-w-3 txt-center wrap-pic-max-s w-full-lg">
				<img src="${pageContext.request.contextPath }/templates/public/images/deal.png" alt="IMG">
			</div>
					...
					<div class="p-rl-15 p-rl-0-xl">
						<div class="size-a-1 flex-col-c-m p-b-44">
							<div class="txt-center txt-m-202 cl10 how-pos1-parent m-b-8">
								SẢN PHẨM ORGANIC HOT

								<div class="how-pos1 p-b-3">
									<img src="${pageContext.request.contextPath }/templates/public/images/icons/symbol-02.2.png" alt="IMG">
								</div>
							</div>
								...
								<div class="item-slick4" >
									<div class="block1">
										<div class="block1-bg wrap-pic-w" >
											...
											<a href="${urlDetail }"><img style="width:307px ; height: 375.22px;" src="${pageContext.request.contextPath }/files/${objProduct.picture}" alt="IMG"></a>
											...
											<div class="block1-content flex-col-c-m p-b-46">
												...
												<div class="block1-wrap-icon flex-c-m flex-w trans-05">
													...
													<a href="javascript:void(0)" title="Kích hoạt" onclick="sanpham(${objProduct.id_product})" class="block1-icon flex-c-m wrap-pic-max-w js-addcart-b1">
														<img src="${pageContext.request.contextPath }/templates/public/images/icons/icon-cart.png" alt="ICON">
													</a>
										...
										<div class="block1-bg wrap-pic-w">
											...
											<div class="block1-content flex-col-c-m p-b-46">
												...
												<div class="block1-wrap-icon flex-c-m flex-w trans-05">
													...
													<a href="javascript:void(0)" onclick="sanpham(${objProduct.id_product})" title="Kích hoạt" class="block1-icon flex-c-m wrap-pic-max-w js-addcart-b1">
														<img src="${pageContext.request.contextPath }/templates/public/images/icons/icon-cart.png" alt="ICON">
													</a>

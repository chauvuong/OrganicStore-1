							...
							<div class="wrap-main-pic-100 bo-all-1 bocl12 pos-relative">
								<div class="main-frame">
									<div class="wrap-main-pic">
										<div class="main-pic">
											<img style="width:598px ; height: 601.73px;" src="${pageContext.request.contextPath }/files/${objNews.picture}" alt="${objNews.name}">
										</div>
									</div>
								</div>
							...
							<div class="wrap-thumb-100 flex-w flex-sb p-t-30">
								<div class="thumb-100">
									<div class="sub-frame sub-1">
										<div class="wrap-main-pic">
											<div class="main-pic">
												<img style="width:180px ; height: 159px;" src="${pageContext.request.contextPath }/files/${objNews.picture}" alt="${objNews.name}">
											</div>
										</div>
			...
			<div class="col-md-5 col-lg-6">
				<div class="p-l-70 p-t-35 p-l-0-lg">
					...
					<div class="flex-w flex-m p-t-30 p-b-27">
						...
						<c:forEach begin="1" end="${numRating}">
							<i class="fa fa-star m-rl-1"></i> 
						</c:forEach>
						<c:forEach begin="1" end="${5- numRating }">
							<i class="fa fa-star-o m-rl-1" ></i>
						</c:forEach>
						</span>
						
						 <span class="txt-s-115 cl6 p-b-3"> (${numberComment } Review) </span>
						</c:when>
						<c:otherwise>
						<span class="fs-16 cl11 lh-15 txt-center m-r-15">
						<i class="fa fa-star m-rl-1" ></i>
					...
					<div class="txt-s-107 p-b-6">
						<span class="cl6"> Giá Tiền: </span> <span class="cl9"> ${objNews.price } </span>
					</div>
					
					<div class="txt-s-107 p-b-6">
						<span class="cl6"> Lượt Xem: </span> <span class="cl9"> ${objNews.count_views } </span>
					</div>
					
					<div class="txt-s-107 p-b-6">
						<span class="cl6"> Preview: </span> <span class="cl9"> ${objNews.preview } </span>
					</div>
							...
							<div class="row p-t-12">
								<div class="col-sm-6 p-b-30">
									<input
										...
										type="text" id="name" required="required" <c:if test="${userInfo != null}"> value="${userInfo.fullname}"</c:if> value="" name="name" placeholder="Tên *">
								</div>

								<div class="col-sm-6 p-b-30">
									<input
										class="txt-s-101 cl3 plh1 size-a-25 bo-all-1 bocl11 focus1 p-rl-20"
										type="text" name="mail" required="required" <c:if test="${userInfo != null}"> value="${userInfo.email}"</c:if> value="" id="mail" placeholder="Email *">
								</div>

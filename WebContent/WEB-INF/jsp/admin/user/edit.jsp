						...
						<form
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Tên Đăng Nhập:</label> 
									<input
										type="text" class="form-control" name="username"  value="<c:if test="${objUser.username ne null}">${objUser.username}</c:if>"
										id="exampleInputEmail1" placeholder="Nhập Tên Đăng Nhập" <c:if test="${objUser != null}"> value="${objUser.username}"</c:if> /> 
							</div>
							<p><form:errors path="objUser.username" cssStyle="color:red; font-family: cursive;"></form:errors></p>
							...
							<p><form:errors path="objUser.fullname" cssStyle="color:red; font-family: cursive;"></form:errors></p>
							...
							<p><form:errors path="objUser.phone" cssStyle="color:red; font-family: cursive;"></form:errors></p>
							...
							<p><form:errors path="objUser.address" cssStyle="color:red; font-family: cursive;"></form:errors></p>

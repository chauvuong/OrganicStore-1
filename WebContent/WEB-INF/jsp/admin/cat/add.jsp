...
<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					...
					<li><i class="fa fa-laptop"></i><a href="${pageContext.request.contextPath }/admin/cat">Danh Mục</a></li>
					<li><i class="fa fa-laptop"></i><a href="${pageContext.request.contextPath }/admin/cat/add">Thêm Danh Mục</a></li>
				</ol>
			</div>
</div>	
<c:choose>

...
<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					...
					<li><i class="fa fa-laptop"></i><a href="${pageContext.request.contextPath }/admin/payment">Hình Thức Thanh Toán</a></li>
				</ol>
			</div>
</div>
<h4>
			...
			<table class="table table-striped table-advance table-hover">
				...
				<c:forEach var="objPay" items="${alPayment}">
					<tr>
						...
						<td>
							<div class="btn-group">
								<a class="btn btn-primary" href="${pageContext.request.contextPath }/admin/payment/edit/${objPay.id_pay }"><i
									class="glyphicon glyphicon-pencil"></i></a> 
								
								<a class="btn btn-danger" href="${pageContext.request.contextPath }/admin/payment/del/${objPay.id_pay }"><i
